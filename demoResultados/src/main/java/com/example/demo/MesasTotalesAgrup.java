...
public class MesasTotalesAgrup {
	...
	public MesasTotalesAgrup(String codigo_distrito, String codigo_seccion, String codigo_circuito, String codigo_mesa,
			String codigo_categoria, String codigo_agrupacion, String votos_agrupacion) {
		super();
